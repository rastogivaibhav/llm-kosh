...
def validate_pack_conformance(zip_path: Path):
    ...
    with zipfile.ZipFile(zip_path) as zf:
        ...
        print(f"PASS: Conforms to Koush Pack Level {level}")
        return True
