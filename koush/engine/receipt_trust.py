...
from koush.core.utils import read_json, write_json, now_iso, slugify
from koush.core.memory import ensure_root
from koush.engine.healing import parse_receipt
...
def receipt_diff(root: Path, receipt_path: Path):
    ensure_root(root)
    from koush.engine.healing import absorb_receipt
