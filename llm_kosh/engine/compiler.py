...
from llm_kosh.core.constants import APP_VERSION
...
from llm_kosh.engine.safety import redact_text, scan_secrets, load_policy
...
def pack_context(
    ...
    from llm_kosh.engine.search import query_memory, read_doc
    ensure_root(root)
