...
from llm_kosh.core.utils import now_iso, sha256_file, write_json, read_json, append_ledger
from llm_kosh.core.memory import ensure_root
from llm_kosh.engine.healing import absorb_receipt, parse_receipt
...
def processor_apply(root: Path, batch_id: str) -> dict:
    ...
    from llm_kosh.core.utils import read_json, append_ledger
